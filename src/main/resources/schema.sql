...
CREATE TABLE user_group_roles (
    ...
    CONSTRAINT fk_user_group_role_user_group FOREIGN KEY (user_group_id) REFERENCES user_groups(id)
);
...
CREATE TABLE bundles (
    ...
    CONSTRAINT fk_bundle_user_group FOREIGN KEY (user_group_id) REFERENCES user_groups(id)
);
...
CREATE TABLE files (
    ...
    CONSTRAINT fk_file_user_group FOREIGN KEY (user_group_id) REFERENCES user_groups(id),
